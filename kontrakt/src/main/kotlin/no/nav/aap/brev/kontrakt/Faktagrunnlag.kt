...
const val FAKTAGRUNNLAG_TYPE_FORELDRE_ANSVAR : String = "FORELDREANSVAR"
enum class FaktagrunnlagType(@JsonValue val verdi: String) {
    ...
    FORELDRE_ANSVAR(FAKTAGRUNNLAG_TYPE_FORELDRE_ANSVAR)
}
...
sealed class Faktagrunnlag(val type: FaktagrunnlagType) {
    ...
    @JsonTypeName(FAKTAGRUNNLAG_TYPE_FORELDRE_ANSVAR)
